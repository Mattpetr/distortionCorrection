...
import pickle # used to save the calibration data for later import in the live program
import os
# Path to the image that you want to undistort
distorted_img_filename = 'chessboard_raw/test26.png'
...
def main():
    ...
    undistorted_img_filename = ("distorted/")
    size = len(os.listdir(undistorted_img_filename))
    new_filename = undistorted_img_filename+str(size)
...
"""loading the pickle file in a new program:"""
